  ...
  public function saveLogs($transaction,$module,$content)
    {
      ...
      DB::statement("INSERT INTO " .$this->db."Leads.dbo.LogsWebCRM (DomainAccount,
                                                                TransactionMode,
                                                                TimeAndDate,
                                                                Module,
                                                                Contents,
   ...
   public function saveCCLogs($transaction,$module,$content,$addressID)
    {
      ...
      DB::statement("INSERT INTO " .$this->db."custo.dbo.LogsCCWebCRM (DomainAccount,
                                                                TransactionMode,
                                                                TimeAndDate,
                                                                Module,
                                                                Contents,
    ...
    public function desktopLog($transactionMode,$module)
    {
      ...
      DB::statement("INSERT INTO " .$this->db."Leads.dbo.LogsVisitor (DomainAccount,
                                                                TransactionMode,
                                                                TimeAndDate,
                                                                Module,
                                                                [IN],
