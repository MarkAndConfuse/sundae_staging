<div class="modal emailRecipientsModal" role="dialog">
    <div class="modal-dialog modal-xl">
        <div class="modal-content pull-right">
        <div class="sModalHeader"><p class="header-label"><i class="fa fa-phone"></i> <b>EMAIL RECIPIENTS</b></p></div>
    <div class="row alert-m">
</div>
<div class="modal-body div-docs">
    <div class="row">
        <div class="col-md-10">
            <label><i class="fa fa-plus-circle"></i> ADD EMAIL RECIPIENTS</label>
        </div>
        <div class="col-md-6">
...
<div class="row">
    <div class="col-md-10">
        <button id="email-notif-btn" type="button" 
            class="btn btn-success btn-sm" onclick="submitEmailRecipients()">
